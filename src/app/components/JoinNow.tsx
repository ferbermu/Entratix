export const JoinNow = () => {
  return (
    <div className="mx-25 px-4 my-16 max-[1280px]:px-0 max-[1280px]:mx-4 bg-[#3BAFBB]/10  rounded-lg  border border-[#1B5055] hover:bg-[#3BAFBB]/20">
      <div className=" items-center justify-center  ">
        ...
        <div className=" flex flex-col items-center gap-12 py-12 px-4 text-white">
          ...
          <button className=" text-[20px] border border-[#3BAFBB] rounded-lg bg-[#3BAFBB] hover:bg-[#3BAFBB]/80 h-14 w-48 cursor-pointer">
            Join Now!
          </button>
        </div>
      </div>
